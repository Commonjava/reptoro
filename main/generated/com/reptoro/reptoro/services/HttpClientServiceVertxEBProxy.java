...
public class HttpClientServiceVertxEBProxy implements HttpClientService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public HttpClientServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public HttpClientServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  void getLocalContentHeadersSync(JsonObject content, Handler<AsyncResult<JsonObject>> handler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getLocalContentHeadersSync");
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        handler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public  void getRemoteContentHeadersSync(JsonObject content, Handler<AsyncResult<JsonObject>> handler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getRemoteContentHeadersSync");
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        handler.handle(Future.failedFuture(res.cause()));
      } else {
