 ...
 */
public abstract class BaseReptoroVerticle extends AbstractVerticle {

  private static final String LOG_EVENT_ADDRESS = "events.log";

  private static final Logger logger = LoggerFactory.getLogger(BaseReptoroVerticle.class);
