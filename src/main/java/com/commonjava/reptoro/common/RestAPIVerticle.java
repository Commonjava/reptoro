 ...
 *
 * @author Georgievski Gjorgji
 */
public abstract class RestAPIVerticle extends BaseReptoroVerticle {
  ...
  protected void enableLocalSession(Router router) {
    ...
    router.route().handler(SessionHandler.create(
      LocalSessionStore.create(vertx, "reptoro.user.session")));
  }
  ...
  protected void enableClusteredSession(Router router) {
    router.route().handler(CookieHandler.create());
    router.route().handler(SessionHandler.create(
      ClusteredSessionStore.create(vertx, "reptoro.user.session")));
  }
