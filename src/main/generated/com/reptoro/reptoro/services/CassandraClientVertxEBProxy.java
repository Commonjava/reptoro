...
public class CassandraClientVertxEBProxy implements CassandraClient {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public CassandraClientVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public CassandraClientVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  void getContentForRepository(String name, Handler<AsyncResult<JsonArray>> handler){
    ...
    _deliveryOptions.addHeader("action", "getContentForRepository");
  ...
  public  void insertRemoteRepositoryData(JsonObject repo, Handler<AsyncResult<JsonObject>> handler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "insertRemoteRepositoryData");
